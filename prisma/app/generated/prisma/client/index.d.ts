...
export namespace Prisma {
  ...
  */
  ...
  export type JournalOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "userId" | "content" | "mood" | "date", ExtArgs["result"]["journal"]>
  ...
  export type JournalWhereUniqueInput = Prisma.AtLeast<{
    id?: string
    userId_date?: JournalUserIdDateCompoundUniqueInput
    AND?: JournalWhereInput | JournalWhereInput[]
    OR?: JournalWhereInput[]
    NOT?: JournalWhereInput | JournalWhereInput[]
    userId?: StringFilter<"Journal"> | string
  ...
  export type JournalUserIdDateCompoundUniqueInput = {
    userId: string
    date: Date | string
  }
