  ...
  return (
    <div id="add" className="hidden">
      <div className="absolute  left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-[5%] bg-white shadow-2xl w-full min-h-screen flex flex-col items-center p-10  md:w-[30%] md:h-[70%] z-50">
        ...
        <textarea
          className="w-full h-full m-5 p-5 text-gray-700 bg-gray-100 rounded-lg  outline-dashed outline-gray-300  resize-none focus:outline-gray-400  "
          placeholder="Write your thoughts here..."
        ></textarea>
        <div className="flex justify-end gap-4 w-full mt-5">
          <button className="bg-green-500   text-white px-4 py-1 rounded-lg hover:bg-green-600 transition duration-200">
            ✔
          </button>
          <button
            onClick={Close}
